...
angular.module('starter')
.controller('LoginController', function($scope, CarroService, $state, $ionicPopup, $rootScope){
...
angular.module('starter').controller('MenuController', function($scope, $rootScope){

	$scope.usuarioLogado = $rootScope.usuario;
});

angular.module('starter')
.controller('EditarPerfilController', function($rootScope, $scope){
